...
const DNotes = ({ notes, setNotes, selected, setSelected }) => {
	...
	return (
		<div className="d_notes">
			<div className="d_notes_title">
				<div
					className="d_notes_title_color"
					style={{ backgroundColor: bgColor }}
				>
					{initials}
				</div>
				<div className="d_notes_title_text">{selectedTitle}</div>
			</div>
			<div className="d_notes_content">
